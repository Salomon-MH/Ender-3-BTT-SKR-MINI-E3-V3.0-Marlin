...
#define STRING_CONFIG_H_AUTHOR "(CUSTOM BLTouch - BigTreeTech, SKR-mini-E3-V3.0)" // Who made the changes.
 ...
 */
/** https://www.reddit.com/r/ender3/comments/1093ib3/bl_touch_and_skr_mini_e3_v3/
 * 
 * It actually works just fine with the 5 pin header, no need to do 3+2 like you have here. I've seen a ton of people struggle with getting the 5-pin header to work properly and from what I can tell it is because they leave out a few steps. If you want to use the 5 pin header, you need to re-map the probe pin in Marlin. The default is pin 32, but if you change it to PC14, it works perfectly.
    define Z_MIN_PROBE_PIN PC14
 * You also need to set the firmware to use the probe pin instead of the endstop pin. Comment out this:
    //#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
