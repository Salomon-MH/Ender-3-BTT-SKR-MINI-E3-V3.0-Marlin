...
- Automatic Bed Leveling Probe
	- 2.1.2.3 & 2.1.2.4: 3D Touch sensor ("3DSWAY" clone) with printed [Adjustable BL-Touch sensor mount](https://www.thingiverse.com/thing:3148733)
	...
	- 2.1.2.6: Original BIQU MicroProbe V2 with the shipped metal bracket for the Ender 3
		- Note that the config greatly differs from the older builds I made for the BLTouch!
		- Reason for the upgrade was that my old 3D Touch sensor broke. It randomly deployed mid-print and got crooked, causing major inaccuracies, even after bending it back visually.
...
Note that the steps above were written for the BLTouch, but should work similarly for the MicroProbe V2.

### 3D Touch / BLTouch compatibility / version (for me: Marlin 2.1.2.3 & 2.1.2.4)
